...
def write_patch_payload(world: "NSMBDSWorld", patch: NSMBDSProcedurePatch) -> None:
    ...
    options = {
        ...
        "secret_exit_shortcut_logic": bool(world.options.secret_exit_shortcut_logic.value),
        "secret_exit_world_unlock_logic": bool(world.options.secret_exit_world_unlock_logic.value),
        "cannon_route_logic": bool(world.options.cannon_route_logic.value),
